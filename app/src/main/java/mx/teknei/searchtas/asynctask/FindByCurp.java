...
public class FindByCurp extends AsyncTask<String, Void, Void> {
    ...
    public FindByCurp(Activity context, String curp, String tokenOld) {
    ...
    protected void onPreExecute() {
        progressDialog = new ProgressDialog(
                activityOrigin,
                activityOrigin.getString(R.string.message_search_curp_operation));
    ...
    protected Void doInBackground(String... params) {
        if (hasConecction) {
            try {
                ...
                Object arrayResponse[] = serverConnection.connection(activityOrigin, null, endPoint + ApiConstants.METHOD_SEARCH_CURP + curp, token, ServerConnection.METHOD_GET, null, "");
